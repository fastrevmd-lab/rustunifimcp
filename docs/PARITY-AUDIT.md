...
Generated by `scripts/audit-legacy-usage.sh`, last run 2026-08-26.
...
| get_client_details | 3 | `unifi_get_resource kind=client` | planned |
...
| list_active_clients | 2 | `unifi_list_resources kind=client` | planned |
...
| list_wan_connections | 1 | `unifi_list_resources kind=wan` | planned |
| list_wan_dns | 1 | `unifi_get_resource kind=wan` | planned |
