...
mod tests {
    ...
    ///
    /// BLOCKED: mecmcp-inventory v0.23.0's `CanonicalEnvelope` does not enforce
    ...
    #[test]
    #[ignore = "mecmcp-inventory v0.23.0 does not enforce deny_unknown_fields on the envelope"]
